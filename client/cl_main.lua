...
TriggerServerEvent("yatzzz:infinity:player:ready")

RegisterNetEvent('yatzzz:infinity:player:coords')
AddEventHandler('yatzzz:infinity:player:coords', function (pCoords)
    PlayerCoords = pCoords
end)

RegisterNetEvent('yatzzz:infinity:entity:coords')
AddEventHandler('yatzzz:infinity:entity:coords', function (pNetId, pCoords)
...
function FetchEntityCoords(pNetId)
    ...
    TriggerServerEvent('yatzzz:infinity:entity:coords', pNetId)
